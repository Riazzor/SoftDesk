...
class ProjectSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ["project_id", "title", "description", "type", "author_user", "created_time", "updated_time"]
        read_only_fields = ["author_user", "created_time", "updated_time"]
        depth = 1

    def to_representation(self, instance):
        data = super().to_representation(instance)
        data["author_user"] = data["author_user"]["email"]
        return data
...
class ContributorSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ["contributor_id", "user", "project", "permission", "role"]
